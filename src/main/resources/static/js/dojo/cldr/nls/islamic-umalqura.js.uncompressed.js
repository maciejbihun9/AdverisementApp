...
//begin v1.x content
{
	...
	"dateTimeFormats-appendItem-Second": "{0} ({toolkit}: {1})",
	...
	"dateTimeFormats-appendItem-Hour": "{0} ({toolkit}: {1})",
	...
	"dateTimeFormats-appendItem-Quarter": "{0} ({toolkit}: {1})",
	...
	"dateTimeFormats-appendItem-Day": "{0} ({toolkit}: {1})",
	...
	"dateTimeFormats-appendItem-Week": "{0} ({toolkit}: {1})",
	...
	"dateTimeFormats-appendItem-Month": "{0} ({toolkit}: {1})",
	...
	"dateTimeFormats-appendItem-Minute": "{0} ({toolkit}: {1})",
