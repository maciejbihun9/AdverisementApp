	...
	var parser = {
		...
		_instantiate: function(nodes, mixin, options, returnPromise){
			...
			if(returnPromise){
				...
				// Back-compat path, remove for toolkit.0
		...
		construct: function(ctor, node, mixin, options, scripts, inherited){
			...
			// TODO: remove scope for toolkit.0
			...
			while(item = attributes[i++]){
				...
				// data-dojo-id or jsId. TODO: drop jsId in toolkit.0
				case "data-dojo-id":
				case "jsid":
					jsname = value;
					break;
			...
			if(scripts){
				for(i = 0; i < scripts.length; i++){
					...
					// FIXME: drop event="" support in toolkit.0. use data-dojo-event="" instead
					...
					if(event){
						if(scriptType == "dojo/connect"){
							...
							// TODO for toolkit.0: use data-dojo-method="foo" instead (also affects dijit/Declaration)
							params[event] = nf;
						}
		...
		scan: function(root, options){
			...
			while(true){
				...
				// TODO: Remove dojoType in toolkit.0
