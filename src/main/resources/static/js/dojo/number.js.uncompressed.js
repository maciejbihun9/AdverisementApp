...
number.round = function(/*Number*/ value, /*Number?*/ places, /*Number?*/ increment){
	...
	// |	>>> number.round(-0.5)
	// |	-1
	// |	>>> number.round(162.295, toolkit)
	// |	162.29  // note floating point error.  Should be 162.3
	// |	>>> number.round(10.71, 0, toolkit.5)
	// |	10.75
...
number.__IntegerRegexpFlags = declare(null, {
	...
	// groupSize2: Number?
	//		second grouping, where separators toolkit..n have a different interval than the first separator (for India)
});
=====*/
